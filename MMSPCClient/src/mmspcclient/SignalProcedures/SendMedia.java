...
public class SendMedia extends ParentSignalProcess implements Runnable{
    public SendMedia() {
        super();
    ...
    public void run() {
        ...
        rf.Close();
        sc.Send(singnals.GeneralSignal(mp.Get_Sender(),mp.Get_Scenario(),(byte)2,103,mp.Get_Priority(),bous.toByteArray(),bousFile.toByteArray()));
    }
