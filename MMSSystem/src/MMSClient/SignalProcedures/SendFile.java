...
public class SendFile extends ParentSignalProcess implements Runnable{
    public SendFile() {
        super();
    ...
    public void run() {
        ...
        rf.Close();
        sc.Send(singnals.GeneralSignal(mp.Get_Sender(),mp.Get_Scenario(),(byte)2,101,mp.Get_Priority(),bous.toByteArray(),bousFile.toByteArray()));
    }
